 ...
 */
class Mdl_Vendor_Custom extends Validator
{
    ...
    public $table = 'ip_vendor_custom';
    public $primary_key = 'ip_vendor_custom.client_custom_id';

    public function default_select()
    {
        $this->db->select('SQL_CALC_FOUND_ROWS ip_vendor_custom.*, ip_custom_fields.*', false);
    }
    ...
    {
        $this->db->join('ip_custom_fields', 'ip_vendor_custom.client_custom_fieldid = ip_custom_fields.custom_field_id', 'inner');
    }
    ...
    public function get_by_vendor($client_id)
    {
        $this->where('client_id', $client_id);
        return $this->get();
    }
    ...
    {
        $this->db->where('ip_vendor_custom.client_id', $client_id);
        return $this;
    }
    ...
    {
        $result = $this->where('ip_vendor_custom.client_id', $client_id)->get()->result();
        return $result;
    }
