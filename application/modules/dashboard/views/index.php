            ...
            <div id="panel-quote-overview" class="panel panel-default overview">
                ...
                <table class="table table-bordered table-condensed no-margin">
                    <?php foreach ($quote_status_totals as $total) { ?>
                        <tr>
                            <td>
                                <a href="<?php echo site_url($total['href'].'_out'); ?>">
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <div id="panel-invoice-overview" class="panel panel-default overview">
                ...
                <table class="table table-bordered table-condensed no-margin">
                    <?php foreach ($invoice_status_totals as $total) { ?>
                        <tr>
                            <td>
                                <?php //echo site_url($total['href'].'_out'); 
                                    $lbl=strtolower($total['label']);
                                ?>
                                <a href="<?php echo site_url('invoices/status/out-'.$lbl); ?>">
                                    <?php echo $total['label']; ?>
                                </a>
                            </td>
                            <td class="amount">
            ...
            <?php } else {
                ...
                <div class="panel panel-danger panel-heading">
                    <?php echo anchor('invoices/status/out-overdue', '<i class="fa fa-external-link"></i> ' . trans('overdue_invoices'), 'class="text-danger"'); ?>
