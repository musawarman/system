...
class Mdl_Quotes extends Response_Model
{
    ...
    public function validation_rules()
    {
        return array(
            ...
            'status_quotes' => array(
                'field' => 'status_quotes',
                'label' => trans('status_quotes')
            ),
            'quote_number' => array(
                'field' => 'quote_number',
                'label' => trans('quote_number')
            ),
            'vendor_id' => array(
                'field' => 'vendor_id',
                'label' => trans('vendor_id')
            ),
            'user_id' => array(
                'field' => 'user_id',
                'label' => trans('user'),
    ...
    public function db_array()
    {
        ...
        // $vid = $this->mdl_clients->where('ip_vendors.vendor_id', $db_array['vendor_id'])->get()->row()->vendor_id;
        // $db_array['vendor_id'] = $vid;
        $st_quotes=$db_array['status_quotes'];
        ...
        if($st_quotes=='in')
        {
            $db_array['quote_number'] = $db_array['quote_number'];
        }
        else
        {
    ...
    {
        $this->filter_where('ip_quotes.vendor_id', $client_id);
        return $this;
    }
