        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                foreach ($dorder as $po) : 
                    ...
                    if(isset($dporder[$po->po_id]))
                    {
                        $pn=$dporder[$po->po_id];
                        $po_number=$pn->po_number;
                        if(isset($quotes[$pn->quotes_id]))
                        {  
                            $quote=$quotes[$pn->quotes_id];
                        ...
                        <td>
                            <div class="options btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('dorder/printcetak/' . $po->do_id); ?>" target="_blank">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('dorder/form'.$st.'/' .$po->po_id); ?>">
