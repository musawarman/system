<div id="headerbar">
    ...
    <h1 class="headerbar-title">Data Jurnal</h1>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group" style="padding-top:30px;">
                            <a href="javascript:excel()" class="btn btn-sm btn-success">Download Excel</a>
                        </div>
                    </div>
...
function loaddata()
{
    var bulan=$('#bulan').val();
    var tahun=$('#tahun').val();
    $('#data').load('<?=site_url()?>/jurnal/data/'+bulan+'/'+tahun);
}
...
function excel()
{
    var bulan=$('#bulan').val();
    var tahun=$('#tahun').val();
    window.open('<?=site_url()?>/jurnal/excel/'+bulan+'/'+tahun,'_blank');
}
</script>