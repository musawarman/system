                ...
                <?php foreach ($data_po as $po) : 
                    ...
                    {  
                        ...
                        foreach($amounts[$po->quotes_id] as $item)
                        {
                            ...
                            $persen=$item->quote_tax_total/($item->quote_item_subtotal==0 ? 1 : $item->quote_item_subtotal) * 100;
                        }
                ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="options btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    ?>
                                        <li>
                                            <a href="<?php echo site_url('dorder/form'.$st_po.'/' . $po->po_id); ?>">
                                                <i class="fa fa-file-pdf-o"></i>&nbsp; Create DO
                                            </a>
                                        </li>
                                    <?php
                                    }
                                    ...
                                    ?>
                                        <li>
                                            <a href="<?php echo site_url('po/printdo/' . $po->po_id); ?>">
