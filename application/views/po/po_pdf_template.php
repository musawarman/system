...
<div style="width:60%;float:left;">
    <div style="width:100%;float:left">
        ...
        <div style="padding:1px 2px;float:left;width:55%;border:1px solid #4687f2;background:#f7f9fc">Bank BNI&nbsp;</div>
        <!--
    ...
    <div style="width:100%;float:left">
        ...
        <div style="padding:1px 2px;float:left;width:55%;border:1px solid #4687f2;background:#f7f9fc">0686730638&nbsp;</div>
    ...
    <div style="width:100%;float:left">
        ...
        <div style="padding:1px 2px;float:left;width:55%;border:1px solid #4687f2;background:#f7f9fc">PT Jedanka Global Sinergi&nbsp;</div>
    ...
    <div style="width:100%;float:left">
        ...
        <div style="width:30%;float:right;text-align:center !important;color:#000 !important;">
            <b>PT. JEDANKA GLOBAL SINERGI</b>
             ...
             <img src="http://system.jedanka.com/uploads/ttdbudi.png" style="max-width:230px; margin-bottom:-40px;"> 
