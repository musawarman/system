            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-5">
                    ...
                    <div class="client-address">
                        ...
                        {
                        ?>
                            <?php $this->layout->load_view('vendors/partial_vendor_address', array('vendor' => $vendor)); ?>
                        <?php
                        }
                        else
                        {
                    ...
                    {
                    ?>
                        <?php if ($vendor->vendor_phone || $vendor->vendor_email) : ?>
                        <hr>
                        <?php endif; ?>
                        <?php if ($vendor->vendor_phone): ?>
                            <div>
                                <?php _trans('phone'); ?>:&nbsp;
                                <?php _htmlsc($vendor->vendor_phone); ?>
                            </div>
                        <?php endif; ?>
                        <?php if ($vendor->vendor_email): ?>
                            <div>
                                <?php _trans('email'); ?>:&nbsp;
                                <?php _auto_link($vendor->vendor_email); ?>
                            </div>
                        <?php endif; ?>
                    <?php
                    }
                    ...
                    <?php if ($invoice->do_file): ?>
                        <div>
                            File DO :&nbsp;
                            <a href="<?=site_url('dorder/printcetak/'.$invoice->invoice_id)?>"><i class="fa fa-file"></i> View File</a>
                        </div>
                    <?php endif; ?>
