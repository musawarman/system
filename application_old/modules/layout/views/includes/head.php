...
<script>
    ...
    $(function () {
        ...
        $(document).on('click', '.create-quote', function () {
            $('#modal-placeholder').load("<?php echo site_url('quotes/ajax/modal_create_quote'); ?>",{jns : '0'});
        });
        $(document).on('click', '.create-quote-in', function () {
            $('#modal-placeholder').load("<?php echo site_url('quotes/ajax/modal_create_quote'); ?>",{jns : 'in'});
        });
        $(document).on('click', '.create-quote-out', function () {
            $('#modal-placeholder').load("<?php echo site_url('quotes/ajax/modal_create_quote'); ?>",{jns : 'out'});
        });
