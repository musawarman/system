...
class Mdl_Payments extends Response_Model
{
    ...
    public function by_vendor($client_id)
    {
        // 
        // return $this;
        // $this->db->select("SQL_CALC_FOUND_ROWS ip_payment_methods.*,ip_invoice_amounts.*,ip_vendors.vendor_name,ip_vendors.vendor_surname,ip_vendors.vendor_id,ip_invoices.invoice_number,ip_invoices.invoice_date_created,ip_payments.*", false)
        ...
        //             ->order_by('ip_payments.payment_date DESC');
        // $this->filter_where('ip_vendors.vendor_id', $client_id);
        return $this;
    }
