<form method="post" action="<?=site_url('invoice/prosesin/'.$idpo)?>" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            ...
            <input class="hidden" id="payment_method_id"
                ...
                <div class="form-group has-feedback">
                    <label for="create_invoice_client_id">PO <?=ucwords($st_po)?> Number</label>
                    <div class="input-group">
                        <select name="po_number" id="po-number" class="po-number form-control"
                                autofocus="autofocus" data-placeholder="PO IN Number" require="required">
